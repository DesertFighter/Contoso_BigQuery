...
{%- set yaml_metadata -%}
source_model: "hub_sales_territory"
src_pk: "sales_territory_hk"
src_ldts: "load_datetime"
as_of_dates_table: "stg_contoso__dim_date"
satellites:
  sat_sales_territory_details:
    pk:
      PK: "sales_territory_hk"
    ldts:
      LDTS: "load_datetime"
  sat_sales_territory_refined:
    pk:
      PK: "sales_territory_hk"
    ldts:
      LDTS: "load_datetime"
stage_tables_ldts:
  sat_sales_territory_details: "load_datetime"
  sat_sales_territory_refined: "load_datetime"
{%- endset -%}
